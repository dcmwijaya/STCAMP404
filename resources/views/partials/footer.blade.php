<!-- Footer -->
<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top border-primary p-5">
    ...
    <ul class="nav col-md-3 justify-content-end list-unstyled d-flex">
        <li class="ms-3"><a type="submit" class="text-muted">
